package es.code.urjc.practica2.security.jwt;
...
public class AccountLoginService {
	...
	public AccountLoginService(AuthenticationManager authenticationManager, UserDetailsService userDetailsService, JwtTokenProvider jwtTokenProvider) {
	...
	public ResponseEntity<AuthResponse> login(HttpServletResponse response, LoginRequest loginRequest) {
		...
		String username = loginRequest.getAccountname();
