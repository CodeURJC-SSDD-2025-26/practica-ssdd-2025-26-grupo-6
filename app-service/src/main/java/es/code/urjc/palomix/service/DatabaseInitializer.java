...
import es.code.urjc.palomix.model.Genre.Genres;
...
import es.code.urjc.palomix.repository.ListsRepository;
import es.code.urjc.palomix.repository.ReviewRepository;
...
public class DatabaseInitializer implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                directorRepository.saveAll(Objects
                                .requireNonNull(List.of(nolan, villeneuve, lynch, nolanJ, gilligan, scorsese, tarantino,
                                                spielberg, hitchcock, kubrick, greta, bong, armstrong, simon, hwang)));
                ...
                try {
                        setFilmographyImage(pulpFiction, "posters/pulpfiction.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(interstellar, "posters/interstellar.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(parasitos, "posters/parasitos.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(odiseaEspacio, "posters/2001.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(succession, "posters/succession.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(theWire, "posters/thewire.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(squidGame, "posters/squidgame.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                try {
                        setFilmographyImage(betterCallSaul, "posters/bettercallsaul.jpg");
                } catch (IOException e) {
                        e.printStackTrace();
                }
                ...
                reviewRepository.saveAll(Objects.requireNonNull(List.of(
                                // Origen (Inception)
                                new Review(5f, "Una obra maestra absoluta. Nolan en su mejor momento.", alice,
                                                inception),
                                new Review(4f, "Mente asombrosa y emocionante. Gana con cada visionado.", bob,
                                                inception),

                                // Dune
                                new Review(5f, "Visualmente impresionante. Una adaptación del libro que quita el aliento.",
                                                alice, dune),
                                new Review(4f, "Una de las mejores películas de ciencia ficción en años.", bob, dune),

                                // Breaking Bad
                                new Review(5f, "Televisión en su máxima expresión. El arco de Walter White no tiene rival.",
                                                alice, breakingBad),
                                new Review(2f, "Adictiva de principio a fin.", bob, breakingBad),

                                // Westworld
                                new Review(3f, "Premisa interesante pero pierde fuelle después de la segunda temporada.",
                                                alice, westworld),

                                // Pulp Fiction
                                new Review(5f, "Diálogos brillantes y una estructura narrativa revolucionaria.",
                                                charlie, pulpFiction),
                                new Review(5f, "Tarantino redefinió el cine de los 90 con esta película.", diana,
                                                pulpFiction),

                                // Interstellar
                                new Review(5f, "Una odisea emocional y científica. La banda sonora de Hans Zimmer es increíble.",
                                                eve, interstellar),
                                new Review(4.5f, "Te deja pensando en el tiempo y el amor mucho después de los créditos.",
                                                frank, interstellar),

                                // Parásitos
                                new Review(5f, "Una crítica social punzante mezclada con un suspense magistral.", grace,
                                                parasitos),
                                new Review(5f, "Impresionante cómo cambia de género a mitad de la película. Cine puro.",
                                                hector, parasitos),

                                // Succession
                                new Review(5f, "Shakespeare en la era de los medios modernos. Los diálogos son puñales.",
                                                ivan, succession),
                                new Review(4.5f, "Odiar a gente rica nunca había sido tan entretenido.", julia,
                                                succession),

                                // El Juego del Calamar
                                new Review(4f, "Un thriller sangriento y adictivo con un trasfondo social muy duro.",
                                                kevin, squidGame),
                                new Review(4f, "No puedes dejar de mirar aunque sea una pesadilla.", laura, squidGame),

                                // Better Call Saul
                                new Review(5f, "Rara vez una precuela está a la altura de la original, pero esta a veces la supera.",
                                                charlie, betterCallSaul),
                                new Review(4.5f, "La evolución de Jimmy a Saul es lenta, pero magistralmente ejecutada.",
                                                diana, betterCallSaul))));
                ...
                Lists actionList = new Lists("Acción", new ArrayList<>(List.of(inception)), Types.MOVIE);
                ...
                Lists sciFiList = new Lists("Ciencia Ficción",
                                new ArrayList<>(List.of(inception, dune, interstellar, odiseaEspacio)), Types.MOVIE);
                sciFiList.setListOwner(null);

                Lists dramaList = new Lists("Drama",
                                new ArrayList<>(List.of(dune, mulhollandDrive, pulpFiction, parasitos, interstellar)),
                                Types.MOVIE);
                dramaList.setListOwner(null);

                Lists suspenseList = new Lists("Suspense",
                                new ArrayList<>(List.of(inception, mulhollandDrive, parasitos)), Types.MOVIE);
                ...
                listsRepository.saveAll(Objects.requireNonNull(List.of(actionList, adventureList, sciFiList, dramaList,
                                suspenseList, horrorList, comedyList, romanceList, crimeList)));
                ...
                Lists dramaSeriesList = new Lists("Drama - Series", new ArrayList<>(
                                List.of(westworld, breakingBad, succession, theWire, betterCallSaul, squidGame)),
                                Types.SERIE);
                dramaSeriesList.setListOwner(null);

                Lists suspenseSeriesList = new Lists("Suspense - Series",
                                new ArrayList<>(List.of(westworld, breakingBad, theWire, squidGame)), Types.SERIE);
                ...
                Lists comedySeriesList = new Lists("Comedia - Series",
                                new ArrayList<>(List.of(breakingBad, succession)), Types.SERIE);
                ...
                listsRepository.saveAll(Objects.requireNonNull(List.of(sciFiSeriesList, dramaSeriesList,
                                suspenseSeriesList, actionSeriesList, comedySeriesList, crimeSeriesList)));
